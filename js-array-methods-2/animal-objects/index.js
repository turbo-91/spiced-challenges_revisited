...
console.log(indexOfAnimalWithNameLongerFive); // 2
...
const africaAnimals = animals.filter((animal) =>
  animal.continents.includes("Africa")
);
console.log(africaAnimals);
const africaAnimalsWeights = africaAnimals.map((animal) => {
  return animal.weight;
});
console.log(africaAnimalsWeights);

const weightOfAllAnimalsInAfrica = africaAnimalsWeights.reduce((a, b) => a + b);
console.log(weightOfAllAnimalsInAfrica);

// Hint: As above, but divided by the number of animals in Africa.
const numberOfAnimals = africaAnimals.length;
console.log(numberOfAnimals);
const averageWeightOfAllAnimalsInAfrica =
  weightOfAllAnimalsInAfrica / numberOfAnimals;
